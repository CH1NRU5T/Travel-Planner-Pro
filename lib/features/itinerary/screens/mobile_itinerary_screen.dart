...
class MobileItineraryScreen extends StatefulWidget {
  const MobileItineraryScreen({super.key, required this.itid});

  final String itid;
  @override
  State<MobileItineraryScreen> createState() => _MobileItineraryScreenState();
}

class _MobileItineraryScreenState extends State<MobileItineraryScreen> {
